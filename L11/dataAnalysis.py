...
# generarea dataset-ului de vanzari
vanzari = []
...
# transformam lista intr-un DataFrame
df = pd.DataFrame(vanzari)

# calculam total vanzari si profit per rand
...
# acest DataFrame poate fi folosit pentru grafice (ex. plt.plot(vanzari_pe_zi['zi'], vanzari_pe_zi['total_vanzari']))
...
# acestea pot fi folosite pentru histogram sau bar chart
